...
import 'package:mirly/examples/widgets/control_button.dart';
...
class _PlacemarkMapObjectExampleState
  ...
  final MapObjectId mapObjectWithDynamicIconId = const MapObjectId(
    'dynamic_icon_placemark',
  );
  final MapObjectId mapObjectWithCompositeIconId = const MapObjectId(
    'composite_icon_placemark',
  );
                      ...
                      onPressed: () async {
                        ...
                        final mapObject =
                            mapObjects.firstWhere(
                                  (el) => el.mapId == mapObjectId,
                                )
                                as PlacemarkMapObject;

                        setState(() {
                          mapObjects[mapObjects.indexOf(mapObject)] = mapObject
                              .copyWith(
                                point: Point(
                    ...
                    ControlButton(
                      onPressed: () async {
                        ...
                        final mapObjectWithDynamicIcon =
                            mapObjects.firstWhere(
                                  (el) =>
                                      el.mapId == mapObjectWithDynamicIconId,
                                )
                                as PlacemarkMapObject;

                        setState(() {
                          mapObjects[mapObjects.indexOf(
                            mapObjectWithDynamicIcon,
                          )] = mapObjectWithDynamicIcon.copyWith(
                            point: Point(
                              latitude:
                                  mapObjectWithDynamicIcon.point.latitude + 1,
                              longitude:
                                  mapObjectWithDynamicIcon.point.longitude + 1,
                            ),
                          );
                        });
                      },
                  ...
                  children: <Widget>[
                    ...
                    ControlButton(
                      onPressed: () async {
                        ...
                        final mapObjectWithCompositeIcon =
                            mapObjects.firstWhere(
                                  (el) =>
                                      el.mapId == mapObjectWithCompositeIconId,
                                )
                                as PlacemarkMapObject;

                        setState(() {
                          mapObjects[mapObjects.indexOf(
                            mapObjectWithCompositeIcon,
                          )] = mapObjectWithCompositeIcon.copyWith(
                            point: Point(
                              latitude:
                                  mapObjectWithCompositeIcon.point.latitude + 1,
                              longitude:
                                  mapObjectWithCompositeIcon.point.longitude +
                                  1,
                            ),
                          );
                        });
